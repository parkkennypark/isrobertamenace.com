...
const HistoryItem = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col -space-y-2", children: [
    /* @__PURE__ */ jsx("p", { className: "font-light text-gray-700", children: date }),
    /* @__PURE__ */ jsx("p", { className: "font-normal text-gray-900", children: description }),
    /* @__PURE__ */ jsx("p", { className: "font-normal text-yellow-600", children: /* @__PURE__ */ jsx("i", { children: change }) })
  ] });
};
...
const sliderImg = "data:image/png;base64,";
const pointerImg = "data:image/png;base64,";
...
function App() {
  ...
  if (loading)
    return /* @__PURE__ */ jsx("div", { className: "flex h-screen items-center justify-center", children: "Loading..." });
  if (error)
    return /* @__PURE__ */ jsxs("div", { className: "p-10 text-red-500", children: [
      "Error: ",
      typeof error === "string" ? error : "Failed to fetch"
    ] });
  if (!data)
    return null;
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto my-auto flex h-screen w-full max-w-[28rem] flex-col items-center px-4 pt-28", children: [
    /* @__PURE__ */ jsx("p", { className: "animate-expand mb-2 text-2xl font-medium md:text-3xl", children: "Is Robert Harris a Menace?" }),
    /* @__PURE__ */ jsx("p", { className: "animate-hover mb-4 text-5xl font-extrabold md:text-6xl", children: data.title }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-12 mt-12 w-full space-y-4 rounded-lg bg-gray-200 p-4", children: [
    ...
    /* @__PURE__ */ jsx(
      "a",
      {
        className: "absolute bottom-0 left-0 p-4 text-xs text-gray-400",
